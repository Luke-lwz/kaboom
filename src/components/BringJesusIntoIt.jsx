...
function BringJesusIntoIt(props) {
    return (
        <div className="w-full border-2 border-neutral rounded-xl p-2 flex flex-col items-center justify-start">
            ...
            <a href="https://www.gotquestions.org/" target="_blank" style={{backgroundColor: "#ffdd00"}} className={"rounded cursor-pointer border-none text-white font-extrabold  py-2 w-full mt-2 btn noskew flex items-center justify-center"}>Got questions?</a>
        </div>
    );
}
