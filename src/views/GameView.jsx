            ...
            conn.on("data", data => {
                switch (data?.intent) {
                    ...
                    case "remote-color-reveal":
                        ...
                        toast(<ColorRevealToast color={color} player={player} />, { id: "color:" + player?.id, duration: 5000, position: "top-left", style: { backgroundColor: "transparent" }, className: "p-0 -mx-3 bg-red-500 w-full max-w-md shadow-none drop-shadow-none" })
                        break;
                    case "remote-card-reveal":
                        ...
                        toast(<CardRevealToast card={{ ...card, color }} player={player} />, { id: "card:" + player?.id, duration: 5000, position: "top-left", style: { backgroundColor: "transparent" }, className: "p-0 -mx-3 bg-red-500 w-full max-w-md shadow-none drop-shadow-none" })
                        break;
                }
            })
    ...
    const PlayerFn = { // functions can be called by peer and by host {intent: "player-fn", payload: {action: "", args. []}}
        ...
        "do-remote-color-reveal": (playerIdArray, color_name) => {
            for (let i = 0; i < playerIdArray.length; i++) {
                ...
                if (playerId?.toUpperCase() === "HOST") toast(<ColorRevealToast color={color} player={player} />, { id: "color:" + playerId, duration: 5000, position: "top-left", style: { backgroundColor: "transparent" }, className: "p-0 -mx-3 bg-red-500 w-full max-w-md shadow-none drop-shadow-none" })
        ...
        "do-remote-card-reveal": (playerIdArray, card) => {
            for (let i = 0; i < playerIdArray.length; i++) {
                ...
                if (playerId?.toUpperCase() === "HOST") toast(<CardRevealToast card={{ ...card, color }} setManu={setMenu} player={player} />, { id: "card:" + playerId, duration: 5000, position: "top-left", style: { backgroundColor: "transparent" }, className: "p-0 -mx-3 bg-red-500 w-full max-w-md shadow-none drop-shadow-none" })
